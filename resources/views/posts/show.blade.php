                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="last_name" class="col-md-3 col-form-label">Text</label>
                                        <div class="col-md-9">
                                            <p class="form-control-plaintext text-muted">{{ $post['text'] }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-plaintext text-muted">{{ $post['email'] }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-plaintext text-muted">{{ $post->category->name }}</p>
                                        </div>
                                    </div>
                                    <hr>
